...
// axes
            VA3C.scene.add( new THREE.ArrowHelper( v(1, 0, 0), v(0, 0, 0), 3000, 0xcc0000) );
            VA3C.scene.add( new THREE.ArrowHelper( v(0, 1, 0), v(0, 0, 0), 3000, 0x00cc00) );
            VA3C.scene.add( new THREE.ArrowHelper( v(0, 0, 1), v(0, 0, 0), 3000, 0x0000cc) );
...
// console.log( event );
        ...
        selMaterial = new THREE.MeshBasicMaterial( { color: '#22bef7', side: '2' });   //color for selected mesh element
        ...
        if ( intersects.length > 0 ) {
         ...
         while(j<intersects.length){
                console.log(intersects[j].object);
             ...
             if(!$.isEmptyObject(intersects[j].object)){
                ...
                displayAttributes( intersects[j].object );
